...
- Copy Page Text runs FJG File Focus's existing action to copy the active note's Markdown body without YAML properties.
...
- `Copy Page Text`: copies the active note's Markdown body without YAML properties by invoking the existing FJG File Focus command.
